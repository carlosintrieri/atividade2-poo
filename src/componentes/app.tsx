  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/formularioCadastroCliente"
          element={<FormularioCadastroCliente />}
        />
        <Route
          path="/formularioCadastroProduto"
        ...
        />
        <Route
          path="/formularioCadastroPedido"
          element={<FormularioCadastroConsumo />}
        />
        <Route
          path="/formularioEdicaoServico"
          element={<FormularioEdicaoServico />}
        />
        <Route
          path="/formularioEdicaoProduto"
          element={<FormularioEdicaoProduto />}
        />
